...
namespace opcodes {
    namespace arm {
        ...
        bool B_BL(const arm_code_t &raw_code) noexcept;
        ...
        bool LDM(const arm_code_t &raw_code) noexcept;
        ...
        bool MSR_OPR(const arm_code_t &raw_code) noexcept;
    ...
    namespace thumb {
        ...
        namespace v5 {
             bool BKPT(const thumb_code_t &raw_code) noexcept;
             bool BLX1(const thumb_code_t &raw_code) noexcept;
             bool BLX2(const thumb_code_t &raw_code) noexcept;
        }
    }
}
