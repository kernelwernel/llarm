// TODO
    ...
    u32 load_store_addressing_mode(const arm_code_t &code) {
        ...
        if (code.test(25) == false) {
            const u16 offset_12 = util::bit_fetcher(code, 0, 11);
        ...
        if (code.test(25) == true) {
            ...
            if (code.test(4) == false) {
                ...
                const u8 shift = util::bit_fetcher(code, 5, 6);
                    ...
                    switch (shift) {
                        ...
                        case 0b10: // ASR
                            if (shift_imm == 0) {
                                ...
                                index = arithmetic_shift_right(Rm, shift_imm);
                            }
                            break;
