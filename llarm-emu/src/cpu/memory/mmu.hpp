...
/*
    ...
    u32 first_coarse(const u32 entry, const u32 address) {
        ...
        const u8 second_level_table_index = shared::util::bit_range(address, 12, 19);
    ...
    u32 first_fine(const u32 entry, const u32 address) {
        ...
        const u8 second_level_table_index = shared::util::bit_range(address, 10, 19);
...
// 
        ...
        // const u8 AP2 = shared::util::bit_range(entry, 8, 9); // TODO: DO SOMETHING WITH THESE
        // const u8 AP3 = shared::util::bit_range(entry, 10, 11); // TODO: DO SOMETHING WITH THESE
...
/*
        ...
        if (entry_id != id::second_level::FAULT) {
            raw_domain_bits = shared::util::bit_range(first_level_entry, 5, 8);
        }
