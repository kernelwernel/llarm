...
bool ARCH_26::is_26_arch_address() const {
    if (settings.no_26_bits) {
        return false;
    }
...
bool ARCH_26::is_fully_26_arch() const {
    return (is_26_arch_address() && is_26_arch_program());
}

bool ARCH_26::is_only_26_arch() const {
    return settings.only_26_bits;
}

bool ARCH_26::is_26_arch_backwards_compatible() const {
    return settings.backwards_compat_support_26_bits;
}

bool ARCH_26::no_26_arch_support() const {
