...
#include "charm-asm/src/disassemble/generators/arm/shifter_operands/shifters.hpp"
...
std::string generators::arm::coprocessor::CDP(const u32 code) {
    ...
    const u8 opcode_1 = shared::util::bit_fetcher<u8>(code, 20, 23);
    const u8 opcode_2 = shared::util::bit_fetcher<u8>(code, 5, 7);
...
std::string generators::arm::coprocessor::MCR(const u32 code) {
    ...
    const u8 opcode_1 = shared::util::bit_fetcher<u8>(code, 21, 23);
    const u8 opcode_2 = shared::util::bit_fetcher<u8>(code, 5, 7);
