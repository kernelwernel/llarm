...
public:
    ...
    u64 read(const id::vfp_reg vfp_reg_id) {
        switch (vfp_reg_id) {
            ...
            case id::vfp_reg::FPSID_IMPLEMENTOR: return shared::util::bit_fetcher(FPSID, 24, 31);
            case id::vfp_reg::FPSID_SW: return (FPSID & (1 << 23));
            case id::vfp_reg::FPSID_FORMAT: return shared::util::bit_fetcher(FPSID, 21, 22);
            case id::vfp_reg::FPSID_SNG: return (FPSID & (1 << 20));
            case id::vfp_reg::FPSID_ARCH: return shared::util::bit_fetcher(FPSID, 16, 19);
            case id::vfp_reg::FPSID_PART_NUM: return shared::util::bit_fetcher(FPSID, 8, 15);
            case id::vfp_reg::FPSID_VARIANT: return shared::util::bit_fetcher(FPSID, 4, 7);
            case id::vfp_reg::FPSID_REVISION: return shared::util::bit_fetcher(FPSID, 0, 3);
            ...
            case id::vfp_reg::FPSCR_RMODE: return shared::util::bit_fetcher(FPSCR, 22, 23);
            case id::vfp_reg::FPSCR_STRIDE: return shared::util::bit_fetcher(FPSCR, 20, 21);
            case id::vfp_reg::FPSCR_LEN: return shared::util::bit_fetcher(FPSCR, 16, 18);
